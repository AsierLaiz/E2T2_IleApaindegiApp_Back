...
class IkasleaKontsumigarriaController extends Controller
{
    ...
    {
        $ikasleaKontsumigarriak = IkasleaKontsumigarria::with(['ikaslea', 'kontsumigarria.kategoria'])
            ->orderBy('erabiltzeko_data', 'desc')
            ->get();
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'erabiltzeko_data' => 'required|date',
            'erabiltzeko_ordua' => 'required|date_format:H:i:s',
        ]);
